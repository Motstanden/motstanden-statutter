...
\usepackage[strict]{changepage} % allows to dynamic change the width of the page
...
\begin{document}%
    ...
    \section{Definisjoner}
            ...
            \begin{definition}[\label{y_faktor_paragraf}]
                ...
                \begin{itemize}
                    ...
                    \item $n$ er \textbf{totalt} antall oppmøtende medlemmer de tre foregående øvelsene. 
                \end{itemize}
            \end{definition}
            \begin{definition}[\label{overkvalifisert_flertall}]
                Overkvalifisert flertall defineres som mer enn $\frac{2}{\pi}$ oppslutning.
            \end{definition}
    ...
    \section{Generalvorssamling}
        ...
        \subsection{Drikkeprotokoller}
            \begin{statute}
                Det skal drikkes hver gang noe vedtas eller avvises på generalvorssamlingen.
            \end{statute}
            \begin{statute}
                Det skal drikkes hver gang noen av følgende ord nevnes på generalvorssamlingen: Volleyball, useriøst, seriøst.
            \end{statute}
