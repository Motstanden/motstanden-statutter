      		...
      		\begin{minipage}{0.9\linewidth}
      			\centering
	       		\begin{minipage}{0.45\linewidth}
		            ...
		            \begin{circuitikz}[scale=1.5]
		            	...
		            	\draw (r-medlem-start) to [short, o-] (0,0) 
		            	to [short] (0,2) 
		            	to [short, -o] (r-medlem-slutt);
		            	%to [open, l^=$R_{medlem}{=}0$] (r-medlem-start);
		            	\draw (1,0) to[R, l_=$R_{tittel}$] (1,2);
		
		            	\node at (3,1) {$R_{medlem}=0$};	
		            \end{circuitikz}
	        	...
	        	\begin{minipage}{0.45\linewidth}
	        		...
	        		\begin{circuitikz}[scale=1.5]
	        			...
	        			\draw (r-medlem-start) to [short, o-] (0,0) 
	        			(0,0) to[R, l_=$R_{tittel}$] (0,2) 
	        			to [short, -o] (r-medlem-slutt);
	        			
	        			\node at (3,1) {$R_{medlem}=R_{tittel}$};	
	        		\end{circuitikz}
